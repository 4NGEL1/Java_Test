...
class CountryServiceTest
{
  ...
  /**
   * Test method for
   * {@link com.axity.office.service.impl.CountryServiceImpl#create(CountryDto)}.
   */
  @Test
  ...
  void testCreate()
  {
    ...
    assertThrows( Exception.class, () -> this.countryService.create( new CountryDto() ) );
  }
  ...
  /**
   * Test method for {@link com.axity.office.service.impl.CountryServiceImpl#delete(String)}.
   */
  @Test
