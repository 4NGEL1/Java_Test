...
class RoleFacadeTest
{
  ...
  /**
   * Test method for
   * {@link RoleFacadeImpl#findRoles(PaginatedRequestDto)}.
   */
  @Test
  void testFindRoles()
  {
  ...
  /**
   * Test method for {@link RoleFacadeImpl#find(String)}.
   */
  @Test
  void testFind()
  {
  ...
  /**
   * Test method for
   * {@link RoleFacadeImpl#create(RoleDto)}.
   */
  @Test
  void testCreate()
  {
  ...
  /**
   * Test method for
   * {@link RoleFacadeImpl#update(RoleDto)}.
   */
  @Test
  void testUpdate()
  {
  ...
  /**
   * Test method for {@link RoleFacadeImpl#delete(String)}.
   */
  @Test
  void testDelete()
  {
